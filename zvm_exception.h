...
#define ZVM_EXCEPT_CODE_INVALID_SHIFT_AMOUNT     8
...
ZVM_EXCEPTION_HANDLER_FUNCTION(invalid_shift_amount);
...
static zvm_exception_entry_t exception_handlers [] = {
    ...
    ZVM_EXCEPTION_HANDLER_ENTRY(EXECUTE, INVALID_SHIFT_AMOUNT, invalid_shift_amount, "invalid shift value")
