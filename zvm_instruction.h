...
#define ZVM_OPCODE_AND        11   
#define ZVM_OPCODE_OR         12
#define ZVM_OPCODE_XOR        13
#define ZVM_OPCODE_NOT        14
#define ZVM_OPCODE_SHL        15
#define ZVM_OPCODE_SHR        16
#define ZVM_OPCODE_JMP         17
...
static const zvm_instruction_metadata_t instruction_handlers [ZVM_INSTRUCTION_MAX_OPCODE + 1] = {
    ...
    ZVM_INSTRUCTION_HANDLER_ENTRY_R(JMP, jmp)
